...
{
    public class BaseFreelancerService<T, IType> : IBaseFreelancerService<T, IType> where T : BaseFreelancer<IType>
    {
        protected readonly AppDbContext Context;

        public BaseFreelancerService(AppDbContext context)
        {
            Context = context;
        }
